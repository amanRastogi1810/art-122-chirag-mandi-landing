...
function TeamHomeOne({ className }) {
    return (
        <>
            <section id='team' className={`appie-team-area pt-90 pb-100 ${className || ''}`}>
